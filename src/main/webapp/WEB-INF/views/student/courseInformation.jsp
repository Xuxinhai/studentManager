            ...
            <div class="box">
                ...
                <div class="box-inner">
                    <form id="serach_form" class="form-search " role="form">
                        ...
                        <div class="col-md-2 col-sm-4 col-xs-12">
                            <div class="form-group">
                                <label class="sr-only">教师</label>
                                <input type="text" name="teachername" class="form-control" placeholder="按教师搜索">
                            </div>
                        </div>
                        <div class="col-md-2 col-sm-4 col-xs-12">
                            <div class="form-group">
                    ...
                    <div class="table-responsive" style="margin-top: 20px;">
                        <table id="stuCourse_table" class="table table-striped">
                            <thead>
                            <tr>
                                <th>#</th>
                                <th>课程号</th>
...
<script type="text/javascript">
    ...
    function build_course_table(result) {
        ...
        $.each(courses,function (index,item) {
            ...
            var teachernameTd = $("<td></td>").append(item.course.teacher.teachername);
            var timeTd = $("<td></td>").append(item.course.time);
            var yearTd = $("<td></td>").append(item.year);


            //append方法返回原来
            $("<tr></tr>").append(courseIdTd)
                .append(coursenoTd)
                .append(coursenameTd)
                .append(teachernameTd)
                .append(timeTd)
                .append(yearTd)
                .appendTo("#stuCourse_table tbody");
